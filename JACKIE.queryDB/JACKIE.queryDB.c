...
{
errAbort(
  "JACKIE.queryDB v1.3 - modified from Kent's bigBedToBed code (https://github.com/ucscGenomeBrowser/kent)\n"
  "For more detailed description, go to https://github.com/albertwcheng/JACKIE2/blob/master/JACKIE.queryDB/\n"
  "usage:\n"
  "   JACKIE.queryDB [options] input.bb [inlineRegionsOrFilters(/separated) ... ]\n"
  "options:\n"
