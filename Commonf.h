...
public:
	...
	inline int write(string filename,std::ios_base::openmode nMode=ios::out|ios::trunc,string newLine="\n")
	{
		int numWrite=0;
...
public:
	...
	inline void flush(std::ios_base::openmode nMode=ios::out|ios::app,bool printEndLine=true)
	{
		ofstream fout(filename.c_str(),nMode);
		if(!fout.good())
		{	
	...
	inline void push(const T& element,std::ios_base::openmode nMode=ios::out|ios::app,bool printEndLine=true)
	{
